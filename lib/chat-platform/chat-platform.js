...
var ChatExpress = function(options) {
  ...
  function mountRoutes(http, routes, chatServer) {
    console.log('monto rotte', routes);

    _(routes).map(function(middleware, route) {
      console.log('mounted ', route);
      http.use(route, middleware.bind(chatServer))
    ...
    createServer: function(options) {
      ...
      var ChatServer = function(options) {
        ...
        this.start = function() {
          ...
          return stack
            .then(function() {
              return mountRoutes(options.http, options.routes, _this);
            })
            .then(function() {
              if (options.debug) {
