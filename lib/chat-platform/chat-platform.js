...
var ChatExpress = function(options) {
  ...
  function createMessage(chatId, userId, messageId, chatServer) {
  ...
  var methods = {
    ...
    createServer: function(options) {
      ...
      var ChatServer = function(options) {
        ...
        this.createMessage = function(chatId, userId, messageId) {
          return createMessage(chatId, userId, messageId, this);
        };
        this.start = function() {
          var _this = this;
          var stack = when(true);
