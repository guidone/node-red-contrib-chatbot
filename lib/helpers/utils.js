...
module.exports = {
  ...
  append: function(message, payload) {
    ...
    } else if (_.isObject(message.payload) && !_.isEmpty(message.payload.type)) {
    ...
    /*else if (message.payload == null
      || (_.isObject(message.payload) && _.isEmpty(message.payload.type))
      || (_.isObject(message.payload) && !_.isEmpty(message.payload.type) && message.payload.inbound === true)) {
      // if there an object
      message.payload = payload;
    } */
