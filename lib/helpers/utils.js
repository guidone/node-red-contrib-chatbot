  ...
  return _(types).any(function(type) {
    ...
    switch(type) {
      ...
      case 'buttons':
        ...
        break;
      case 'filepath':
        return _.isString(value) && validators.filepath(value);
      case 'url':
        return _.isString(value) && validators.url(value);
      default:
...
const utils = {
  ...
  extractValue: function(types, name, node, message, usePayload = true, useMessage = false) {
