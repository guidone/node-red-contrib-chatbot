...
const EVENT_MAGIC_KEYWORDS = ['referral', 'optin', 'delivery', 'account_linking', 'read'];
  ...
  */
  ...
  broadcastStoreMessage: function(payload) {
    ...
    return new Promise(function (resolve, reject) {
      request({
        method: 'POST',
        uri: `${FACEBOOK_API_URL}/me/message_creatives`,
        qs: {
          access_token: options.token
        },
        json: {
  ...
  broadcastSendMessage: function(messageId, params) {
    ...
    return new Promise(function (resolve, reject) {
      request({
        method: 'POST',
        uri: `${FACEBOOK_API_URL}/me/broadcast_messages`,
        qs: {
          access_token: options.token
        },
        json: json
  ...
  broadcastMetrics: function(broadcastId) {
    ...
    return new Promise(function (resolve, reject) {
      request({
        method: 'GET',
        uri: `${FACEBOOK_API_URL}/${broadcastId}/insights/messages_sent`,
        qs: {
          access_token: options.token
        },
        json: {}
  ...
  broadcastCancel: function(broadcastId) {
    ...
    return new Promise(function (resolve, reject) {
      request({
        method: 'POST',
        uri: `${FACEBOOK_API_URL}/${broadcastId}`,
        qs: {
          access_token: options.token,
          operation: 'cancel'
        },
