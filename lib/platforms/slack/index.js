...
const Slack = new ChatExpress({
  ...
  onStart: function() {
    ...
    return new Promise(resolve => {
      ...
      const slackEvents = createEventAdapter(options.signingSecret);
      ...
      chatServer.server.listen(serverPort, () => {
        // TODO improve message in console
        console.log(`Listening for events on ${chatServer.server.address().port}`);
        resolve();
      });
    });
  },
